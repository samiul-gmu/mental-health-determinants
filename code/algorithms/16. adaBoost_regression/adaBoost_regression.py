# -*- coding: utf-8 -*-
"""
Created on Fri Jan 31 09:14:04 2025
...
# Function to fit and evaluate AdaBoost Regressor
def fit_and_evaluate_adaboost(X_train, X_test, y_train, y_test, target_name, n_estimators=50, learning_rate=1.0):
    """
    Fits an AdaBoost regression model and evaluates its performance.
    ...
    Parameters:
        ...
        learning_rate: Step size for boosting (default: 1.0)
    """
    ...
    print(f"\nAdaBoost Regression Model for {target_name} (n_estimators={n_estimators}, learning_rate={learning_rate})")
    print(f"Mean Squared Error (MSE): {mse:.4f}")
    print(f"R-squared (R2): {r2:.4f}")

    # Save results to CSV
    save_results_to_csv('AdaBoost Regression', target_name, mse, r2)
...
# Fit and evaluate AdaBoost models
fit_and_evaluate_adaboost(X1_train, X1_test, y1_train, y1_test, dVar1, n_estimators=100, learning_rate=0.1)
fit_and_evaluate_adaboost(X2_train, X2_test, y2_train, y2_test, dVar2, n_estimators=100, learning_rate=0.1)
