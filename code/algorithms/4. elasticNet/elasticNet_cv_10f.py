...
@author: Sami (Updated for 10-Fold Cross-Validation with ElasticNet Regression)
"""
...
# Function to perform 10-fold cross-validation using ElasticNet Regression
def cross_validate_elasticnet(X, y, target_name, alpha=1.0, l1_ratio=0.5, n_splits=10):
    ...
    print(f"\n10-Fold Cross-Validation Results for ElasticNet Regression ({target_name}, Alpha={alpha}, L1 Ratio={l1_ratio}):")
    print(f"Average MSE: {avg_mse:.4f}")
    print(f"Average R²: {avg_r2:.4f}")

    # Save results to CSV
    save_results_to_csv('ElasticNet Regression (10-Fold CV)', target_name, avg_mse, avg_r2)
...
# Run 10-fold cross-validation for both dependent variables using ElasticNet Regression
# cross_validate_elasticnet(X, y1, dVar1, alpha=1.0, l1_ratio=0.5)
cross_validate_elasticnet(X, y2, dVar2, alpha=1.0, l1_ratio=0.5)
