...
@author: Sami (Updated for 10-Fold Cross-Validation with Random Forest Regression & Hyperparameter Tuning)
"""
...
# Function to perform Random Forest Regression with hyperparameter tuning
def cross_validate_random_forest_with_tuning(X, y, target_name, n_splits=10):
    ...
    print(f"\n10-Fold Cross-Validation Results for Random Forest Regression ({target_name}, Best n_estimators={best_n_estimators}, Best max_depth={best_max_depth}, Best min_samples_split={best_min_samples_split}):")
    print(f"Average MSE: {avg_mse:.4f}")
    print(f"Average R²: {avg_r2:.4f}")

    # Save results to CSV
    save_results_to_csv(f'Random Forest Regression (10-Fold CV, Best n_estimators={best_n_estimators}, Best max_depth={best_max_depth}, Best min_samples_split={best_min_samples_split})', target_name, avg_mse, avg_r2)
...
# best_n_estimators_1, best_max_depth_1, best_min_samples_split_1, mse_1, r2_1 = cross_validate_random_forest_with_tuning(X, y1, dVar1)
best_n_estimators_2, best_max_depth_2, best_min_samples_split_2, mse_2, r2_2 = cross_validate_random_forest_with_tuning(X, y2, dVar2)
