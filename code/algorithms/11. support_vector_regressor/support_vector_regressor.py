# -*- coding: utf-8 -*-
"""
Created on Fri Jan 31 08:12:26 2025
...
# Function to fit and evaluate a Support Vector Regressor
def fit_and_evaluate_svr(X_train, X_test, y_train, y_test, target_name, kernel='rbf', C=1.0, epsilon=0.1):
    """
    Fits a Support Vector Regression model and evaluates its performance.
    ...
    Parameters:
        ...
        epsilon: Insensitive loss margin (default: 0.1)
    """
    ...
    print(f"\nSupport Vector Regression Model for {target_name} (Kernel={kernel}, C={C}, Epsilon={epsilon})")
    print(f"Mean Squared Error (MSE): {mse:.4f}")
    print(f"R-squared (R2): {r2:.4f}")

    # Save results to CSV
    save_results_to_csv('Support Vector Regression', target_name, mse, r2)

# Fit and evaluate SVR models
# fit_and_evaluate_svr(X1_train_scaled, X1_test_scaled, y1_train_scaled, y1_test_scaled, dVar1, kernel='rbf', C=1.0, epsilon=0.1)
fit_and_evaluate_svr(X2_train_scaled, X2_test_scaled, y2_train_scaled, y2_test_scaled, dVar2, kernel='rbf', C=1.0, epsilon=0.1)
