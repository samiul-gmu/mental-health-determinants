...
@author: Sami (Updated for 10-Fold Cross-Validation with K-Nearest Neighbors Regression)
"""
...
# Function to perform 10-fold cross-validation using K-Nearest Neighbors Regression
def cross_validate_knn(X, y, target_name, n_neighbors=5, weights='uniform', n_splits=10):
    ...
    print(f"\n10-Fold Cross-Validation Results for KNN Regression ({target_name}, n_neighbors={n_neighbors}, weights={weights}):")
    print(f"Average MSE: {avg_mse:.4f}")
    print(f"Average R²: {avg_r2:.4f}")

    # Save results to CSV
    save_results_to_csv('K-Nearest Neighbors Regression (10-Fold CV)', target_name, avg_mse, avg_r2)

# Run 10-fold cross-validation for both dependent variables using KNN Regression
#cross_validate_knn(X_scaled, y1_scaled, dVar1, n_neighbors=5, weights='uniform')
cross_validate_knn(X_scaled, y2_scaled, dVar2, n_neighbors=5, weights='uniform')
